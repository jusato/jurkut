...
// Menu
// ================================================================================================================
export function JurkutMenu({ githubUser }) {
  ...
  return (
    <JurkutMenu.Wrapper isMenuOpen={isMenuOpen}>
      ...
      <JurkutMenuProfileSidebar githubUser={githubUser} />
    </JurkutMenu.Wrapper>
  )
}
...
function JurkutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="jurkutMenuProfileSidebar">
      <div>
...
// JurkutProfileSidebarMenuDefault
// ================================================================================================================
export function JurkutProfileSidebarMenuDefault() {
  return (
    <JurkutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
